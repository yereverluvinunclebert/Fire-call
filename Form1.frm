...
'    End If
    ...
    ' run the housekeeping logic on startup
    Call houseKeepingTimerLogic("startup")
...
Private Sub lbxOutputTextArea_Click() '(Optional ByRef frm As Form)
   ...
   On Error GoTo lbxOutputTextArea_Click_Error
    ...
    lbxOutputTextAreaHasFocus = True
    lbxInputTextAreaHasFocus = False
    lbxCombinedTextAreaHasFocus = False
...
Private Sub lbxInputTextArea_Click()
   ...
   On Error GoTo lbxInputTextArea_Click_Error
    ...
    lbxOutputTextAreaHasFocus = False
    lbxInputTextAreaHasFocus = True
    lbxCombinedTextAreaHasFocus = False
    ...
    ' MsgBox "lbxInputTextAreaHasFocus = " & lbxInputTextAreaHasFocus
...
Private Sub lbxCombinedTextArea_Click()
   ...
   On Error GoTo lbxCombinedTextArea_Click_Error
    ...
    lbxOutputTextAreaHasFocus = False
    lbxInputTextAreaHasFocus = False
    lbxCombinedTextAreaHasFocus = True
...
Private Sub menuRefresh()
    ...
    If lbxInputTextAreaHasFocus = True Then
        ' MsgBox "lbxInputTextAreaHasFocus = " & lbxInputTextAreaHasFocus
        If lbxInputTextArea.Visible = True Then lbxInputTextArea.Clear
        Call populateInputBox
    End If
    
    If lbxOutputTextAreaHasFocus = True Then
    ...
    If lbxCombinedTextAreaHasFocus = True Then
...
'
' ----------------------------------------------------------------
' Procedure Name: opacityFadeInTimer_Timer
' Purpose:  a timer that makes the main form visible, then increases the opacity to full
' Procedure Kind: Sub
...
Private Sub opacityFadeInTimer_Timer()
    ...
    On Error GoTo opacityFadeInTimer_Timer_Error
            'If opacitylevel <= opacitylevel Then ' as soon as the form opacity starts to be not 0 then the form is made visible
...
opacityFadeInTimer_Timer_Error:
    ...
    MsgBox "Error " & err.Number & " (" & err.Description & ") in procedure opacityFadeInTimer_Timer, line " & Erl & "."
