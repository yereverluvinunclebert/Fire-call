...
Public lbxOutputTextAreaHasFocus As Boolean
Public lbxInputTextAreaHasFocus      As Boolean
Public lbxCombinedTextAreaHasFocus      As Boolean
...
'---------------------------------------------------------------------------------------
'
Public Sub restoreMainWindowOpacity()
...
Public Sub houseKeepingTimerLogic(Optional ByVal runMode As String)
    Dim lastInputVar As LASTINPUTINFO
    ...
    Else
        ...
        If Not fInIDE Then
            ...
            If houseKeepingTimerID = 0 Then
                ' this has a callback routine that it jumps to on each interval completion
                'MsgBox "startTheHouseKeepingTimers " & HouseKeepingIntervalMillisecs
...
WinProc_Error:
     ...
     MsgBox "Error " & err.Number & " (" & err.Description & ") in procedure WinProc of Module modCommon"
End Function
...
SubClassWnd_Error:
     ...
     MsgBox "Error " & err.Number & " (" & err.Description & ") in procedure SubClassWnd of Module modCommon"
End Sub
...
Sub UnSubclassWnd(hwnd As Long)
    On Error GoTo UnSubclassWnd_Error
...
UnSubclassWnd_Error:
     ...
     MsgBox "Error " & err.Number & " (" & err.Description & ") in procedure UnSubclassWnd of Module modCommon"
End Sub
