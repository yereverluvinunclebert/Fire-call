...
' ----------------------------------------------------------------
' Procedure Name: FormDblClickSub
' Purpose: if the program is minimised, maximise it
' Procedure Kind: Sub
...
FormDblClickSub_Error:
    ...
    MsgBox "Error " & err.Number & " (" & err.Description & ") in procedure FormDblClickSub, line " & Erl & "."
